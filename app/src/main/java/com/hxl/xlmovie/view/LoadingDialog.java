...
import com.hxl.xlmovie.util.DensityUtil;
...
public class LoadingDialog extends Dialog {
    ...
    public void show() {
        ...
        if (loadingView != null) {
            ...
            if (!loadingView.isShown()) loadingView.show();
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingView = (AVLoadingIndicatorView) findViewById(R.id.aviLoading);
    ...
    private void initDialogWindow() {
        ...
        p.width = DensityUtil.dip2px(getContext(), 160);    // 宽度设置为屏幕的0.9
